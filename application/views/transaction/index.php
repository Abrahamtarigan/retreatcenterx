    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
          aria-selected="true">Total Transaksi</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-warning" id="settings-tab" data-toggle="tab" href="#settings" role="tab"
          aria-controls="settings" aria-selected="false">Transaksi Berjalan</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-success" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
          aria-controls="profile" aria-selected="false">Transaksi Sukses</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-danger" id="messages-tab" data-toggle="tab" href="#messages" role="tab"
          aria-controls="messages" aria-selected="false">Transaksi Batal</a>
      </li>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
        ...
        <table id="menadata" class="table">
          ...
          <tbody>
            <?php $i = 1; ?>
            <?php foreach ($getAllTransactions as $gts) { ?>
              <?php
              date_default_timezone_set('Asia/Jakarta');
              $current_date = date('Y-m-d H:i:s');

              $tgl_check_in = date_create($gts->bookingStDt);
              $tgl_check_out = date_create($gts->bookingEdDt);
              $time_booking = date_create($gts->bookingTime);
              $end_period = date_create($gts->bookingTimeStacEnd);
              ...
              <tr>
                <th><a style="font-weight:bold">
                  ...
                  <small>Id Booking : <a style="font-weight:bold">
                      <?= $gts->bookingId_text; ?></small></a><br />
                  <small>Check-in : <a class="text-orange" style="font-weight:bold">
                      <?= $formatted_date_check_in_date; ?>&nbsp;
                      <?= $formatted_date_check_in_time; ?></small></a>
                  <small>Check-out : <a class="text-orange" style="font-weight:bold">
                      <?= $formatted_date_check_out_date; ?>&nbsp;
                      <?= $formatted_date_check_out_time; ?></small></a><br />
                  ...
                  <small>End Period Payments: <a class="text-danger" style="font-weight:bold">
                      <?= $formatted_end_period_payment; ?></small></a><br />
                  <small>Total Bayar :<a class="text-black" style="font-weight:bold; font-size:17px;"> Rp.
                      <?= number_format($gts->bookingTotalPay, 0, ".", ".") ?></small></a>

                </th>


                <td style="width:200px;">
                  <?php if ($gts->status_booking == 2) {
                    ?>
                    <div class="alert alert-success" role="alert">
                      <?= $gts->status_booking_name; ?>
                    </div>
                    <?php
                  } else if ($gts->status_booking_name == 1) {
                    ?>
                      <div class="alert alert-warning" role="alert">
                      <?= $gts->status_booking; ?>
                      </div>
                    <?php
                  } else if ($gts->status_booking_name == 0) {
                    ?>
      ...
      <div class="tab-pane" id="settings" role="tabpanel" aria-labelledby="settings-tab">
        ...
        <table id="example" class="table table-striped">
          <thead>
            <tr>
              <th style="width:180px;">Booking Details</th>
              ...
              <tr>
                <th><a style="font-weight:bold">
                  ...
                  <small>Booking Id : <a style="font-weight:bold">
                      <?= $gaog->bookingId_text; ?></small></a><br />
                  <small>Check-in : <a class="text-orange" style="font-weight:bold">
                      <?= $formatted_date_check_in_date; ?>&nbsp;
                      <?= $formatted_date_check_in_time; ?></small></a>
                  <small>Check-out : <a class="text-orange" style="font-weight:bold">
                  ...
                  <small>Total Bayar :<a class="text-black" style="font-weight:bold; font-size:17px;"> Rp.
                      <?= number_format($gaog->bookingTotalPay, 0, ".", ".") ?></small></a>
                ...
                <td>
                  ...
                  if ($gaog->status_booking == 1) {
                    ...
                    ?>
                    <a data-toggle="modal"
                      class="add-facility-js btn btn-success hupdate-record add-facility btn-sm"></i>&nbsp;Transaksi
                      Sukses</a>
                    <hr />
                    ...
                    ?>
                    <a data-toggle="modal"
                      class="add-facility-js btn btn-primary hupdate-record add-facility text-white btn-sm"></i>&nbsp;Menunggu
                  ...
                  if ($role_id == 1 || $role_id == 2 || $gaog->status_booking == 1) {
                    ?>
                    <a data-toggle="modal" data-target="#add-facility<?= $gaog->bookingId; ?>"
                      class="add-facility-js badge badge-danger text-white hupdate-record add-facility"></i>&nbsp;Ubah
                      Harga</a><br />
                    <a data-toggle="modal" data-target="#lihat-konfirmasi<?= $gaog->bookingId; ?>"
                      class="add-facility-js badge badge-warning hupdate-record add-facility"></i>&nbsp;Lihat Konfirmasi
                      Transaksi</a>
                    <a data-toggle="modal" data-target="#validasi-pembayaran<?= $gaog->bookingId; ?>"
                      class="add-facility-js badge badge-success hupdate-record add-facility"></i>&nbsp;Validasi</a>
                    <hr />
                  ...
                  if ($gaog->userEditKeterangan == '-') {
                    ...
                    ?>
                    <a data-toggle="modal" data-target="#cek-perubahan<?= $gaog->bookingId; ?>"
                      class="add-facility-js badge badge-info hupdate-record add-facility"></i>&nbsp;Lihat Keterangan
                      Perubahan</a>
                    <?php
                  }
      ...
      <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <?php include 'transaksi_sukses.php'; ?>
      </div>

      <div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab">
        <?php include 'transaksi_batal.php'; ?>
      </div>
...
foreach ($getAllOnGoingTransactions as $gaog):
  ...
  <form action="<?php echo site_url('transactions/ubah_harga'); ?>" method="post">
    <div class="modal fade bd-example-modal-lg" id="add-facility<?= $gaog->bookingId; ?>" role="dialog"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Ubah total harga&nbsp;<?= $gaog->bookingId_text; ?></h5>
          ...
          <div class="modal-body">
            ...
            <div class="alert alert-warning Text-bold btn-sm">Total Pembayaran ini akan diubah oleh
              <?= $user['userNama']; ?>
            </div>
...
foreach ($getAllOnGoingTransactions as $gaog):
  ...
  <form action="<?php echo site_url('transactions/validate'); ?>" method="post" enctype="multipart/form-data">
    <div class="modal fade bd-example-modal-lg" id="validasi-pembayaran<?= $gaog->bookingId; ?>" role="dialog"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Validasi Pembayaran&nbsp;<?= $gaog->bookingId_text; ?></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            ...
            <div class="alert alert-warning Text-bold btn-sm">Status Pembayaran ini akan divalidasi oleh
              <?= $user['userNama']; ?>
            </div>
              ...
              <div class="col-sm-10">
                ...
                foreach ($getValidateOption as $gvo):
                  ...
                  <select name="status_booking" class="form-control" required>
                    ...
                    <option value="<?= $gvo->status_booking_id; ?>"><?= $gvo->status_booking_name; ?></option>
...
foreach ($getAllOnGoingTransactions as $gaog):
  ...
  <form action="" method="post">
    <div class="modal fade bd-example-modal-lg" id="cek-perubahan<?= $gaog->bookingId; ?>" role="dialog"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Keterangan Perubahan&nbsp;<?= $gaog->bookingId_text; ?></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
...
foreach ($getAllOnGoingTransactions as $gaog):
  ...
  <form action="<?= base_url('transactions/validate_confirmation'); ?>" method="post">
    <div class="modal fade bd-example-modal-lg" id="lihat-konfirmasi<?= $gaog->bookingId; ?>" role="dialog"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <div class="Text-bold btn-sm">
              ...
              <hr />
              <?= $gaog->userEditKeterangan; ?>
              <img src="<?= base_url('upload/payment_proved/' . $gaog->payment_prove_image); ?>" alt="..."
                class="img-thumbnail">
            </div>
