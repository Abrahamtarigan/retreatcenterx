                                          ...
                                          <div class="border-bottom-1">
                                              <div id="datepickerWrapperFromOne" class="u-datepicker input-group">
                                                  <div class="input-group-prepend">
                                                   ...
                                                   <input name="bookingStDt" style="color:whitesmoke;" class="datepicker font-size-17  text-warning shadow-none font-weight-bold form-control hero-form bg-transparent  border-0" type="date" value="<?php echo date('Y-m-d');?>" min="<?php echo date('Y-m-d');?>">
                                              </div>
                                               <!-- End Datepicker -->
                                          </div>
                                          <!-- End Input -->
                                          ...
                                          <div class="border-bottom-1">
                                              <div id="datepickerWrapperFromOne" class="u-datepicker input-group">
                                                  <div class="input-group-prepend">
                                                   ...
                                                   <input name="bookingEdDt" style="color:whitesmoke;" class="datepicker font-size-17  text-warning " type="date" id="txtDate" value="<?php echo $tomorrow;?>" min="<?php echo $tomorrow;?>">
                                              </div>
                                               <!-- End Datepicker -->
                                          </div>
                                          <!-- End Input -->
