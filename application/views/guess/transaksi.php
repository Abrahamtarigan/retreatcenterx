<h5 class="card-title">
  <table id="menadata" class="display " style="width:100%; ">
    ...
    ?>
      ...
      <tr>
        <td class=""><a style="font-size:26px;color:black;font-weight:bold;"><?= $gt->roomName; ?></a>
          <h6><i class="icon flaticon-placeholder mr-2 font-size-10"><?= $gt->roomLocation; ?></i></a></h6>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-bookmarks" viewBox="0 0 16 16">
            ...
            <small><a style="font-size:13 px;font-weight:bold;">
                ...
                Check-in:&nbsp;<?= $formatted_date_check_in_date; ?></a>
              <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jam <?= $formatted_date_check_in_time; ?><h6>
        ...
        <td>
          ...
          if ($gt->status_booking == 1) {
          ?>
            <a data-toggle="modal" data-target="#validasi-pembayaran<?= $gt->bookingId; ?>" class="add-facility-js btn btn-warning hupdate-record add-facility"></i>&nbsp;Pembayaran Sekarang</a>
            <hr />
          <?php
          } elseif ($gt->status_booking == 3) {
          ?>
            <a data-toggle="modal" class="add-facility-js btn btn-primary hupdate-record add-facility text-white"></i>&nbsp;Menunggu Proses Validasi Admin</a>
            <hr />
          <?php
          } elseif ($gt->status_booking == 2) {
          ?>
            <a data-toggle="modal" class="add-facility-js btn btn-success hupdate-record add-facility text-white"></i>&nbsp;Transaksi Sukses</a>
            <hr />
          <?php
          } elseif ($gt->status_booking == 0) {
