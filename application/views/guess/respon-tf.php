...
<!-- Modal Pembayaran -->
   ...
   <?php $no=0; foreach($getBookings as $gb): $no++; ?>
<form action="<?php echo base_url('guess/validate'); ?>" method="POST"  enctype="multipart/form-data">
  <div class="modal fade bd-example-modal-lg" id="validasi-pembayaran<?=$gb->bookingId;?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Validasi Pembayaran&nbsp;<?=$gb->bookingId_text;?></h5>
        ...
        <div class="modal-body">
            <center>
            <div class="clockdiv alert alert-danger btn-sm" data-date="<?= $gb->bookingTimeStacEnd;?>">
            ...
            <div class="form-group row">
              ...
              <input type="hidden" name="bookingId" value="<?=$gb->bookingId;?>" class="form-control">
