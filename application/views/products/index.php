        ...
        <?php foreach ($getAllProducts as $gap) : ?>
          <tr>
            <th><a style="font-weight:bold"><?= $gap->roomName ?></a><br />
              ...
              <a style="color:white;" data-toggle="modal" data-target="#add-picture<?= $gap->roomId;?>" class="badge badge-green btn-sm update-record tombol-hapus-menu"></i>&nbsp;Tambah Gambar</a>
...
<?php $no=0; foreach($getAllProducts as $gap): $no++; ?>
