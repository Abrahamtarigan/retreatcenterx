                     ...
                     <article class="card-group-item">
                            ...
                            <div class="filter-content">
                                   <div class="jumbotron">
                                          ...
                                          <hr>
                                          <small>Lihat dan cetak report dengan klik tombol dibawah</small>
                                          <hr>
                                          <p class="lead">
                                                 <a type="button" data-toggle="modal" class="btn btn-default rounded text-white btn-sm" data-target="#modal_tambah_produk" data-whatever="@mdo" style="border-radius:12px;background:linear-gradient(109.6deg, rgb(20, 30, 48) 11.2%, rgb(36, 59, 85) 91.1%);">Laporan</a>
                                          </p>
